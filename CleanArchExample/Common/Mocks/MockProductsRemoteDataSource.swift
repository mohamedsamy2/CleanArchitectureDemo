...
class MockProductsRemoteDataSource: ProductsRemoteDataSourceProtocol {
    ...
    func getProducts(completion: @escaping (Result<ProductsResponse, Error>) -> Void) {
        ...
        let product1 = Product(id: 1, price: 20.0, oldPrice: 30.0, discount: 10, image: "image_url_1", name: "Mock Product 1", description: "Description 1", images: ["image_url_1_1", "image_url_1_2"], inFavorites: false, inCart: true)

        let product2 = Product(id: 2, price: 25.0, oldPrice: 35.0, discount: 10, image: "image_url_2", name: "Mock Product 2", description: "Description 2", images: ["image_url_2_1", "image_url_2_2"], inFavorites: true, inCart: false)

        let product3 = Product(id: 3, price: 30.0, oldPrice: 40.0, discount: 10, image: "image_url_3", name: "Mock Product 3", description: "Description 3", images: ["image_url_3_1", "image_url_3_2"], inFavorites: false, inCart: false)
